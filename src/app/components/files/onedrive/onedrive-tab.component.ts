...
@Component({
    selector: 'onedrive-tab',
    templateUrl: '../../../html/files/onedrive-tab.component.html'
})

export class OneDriveTabComponent implements OnInit {
    ...
    public generateLink(fileId: string, cloud: string) {
        return this.foldersService.getFileUrl(fileId, cloud, this.userId).then((data: any) => {
            if (data.file_url) {
    ...
    public getFolders() {
        ...
        // if(folderFromStorage && folderFromStorage.onedrive) {
        //     const self: any = this;
        //     setTimeout(function() {
        //         self.foldersStructure = folderFromStorage.onedrive;
        ...
        // } else {
            ...
            this.foldersService.getFolders(userData).then((data: any) => {
                if (data.status) {
                    ...
                    folderFromStorage.onedrive = data.folders;

...
@Component({
    selector: 'google-tab',
    templateUrl: '../../../html/files/google-tab.component.html'
})

export class GoogleTabComponent implements OnInit {
    ...
    public getFolders() {
        ...
        // if(folderFromStorage && folderFromStorage.gdrive) {
        //     const self: any = this;
        //     setTimeout(function() {
        //         self.foldersStructure = folderFromStorage.gdrive;
        ...
        // } else {
            ...
            this.foldersService.getFolders(userData).then((data: any) => {
                if (data.status) {
                    ...
                    folderFromStorage.gdrive = data.folders;
